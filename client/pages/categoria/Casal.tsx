...
export default function CasalPage() {
  useDocumentTitle({ title: "Vídeos Casal - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("casal-videos-rt")
    ...
    const ch2 = supabase.channel("casal-likes-rt")
