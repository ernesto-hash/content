// src/pages/categoria/GayAuthenticated.tsx
...
export default function GayAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("gay-auth-videos-rt")
    ...
    const ch2 = supabase.channel("gay-auth-likes-rt")
