// src/pages/categoria/Interativo.tsx
...
export default function InterativoPage() {
  useDocumentTitle({ title: "Vídeos Interativos - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("interativo-videos-rt")
    ...
    const ch2 = supabase.channel("interativo-likes-rt")
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-400/20 via-fuchsia-600/10 to-transparent border border-purple-400/25 p-8">
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-foreground/60 text-sm max-w-md">Vídeos com escolhas e experiências interativas.</p>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="flex items-center gap-2 flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5">
            ...
            <input value={query} onChange={(e) => setQuery(e.target.value)}
              placeholder="Pesquisar em Interativo..."
          ...
          <div className="flex flex-col items-center justify-center py-32 gap-4">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-foreground/35 text-sm max-w-xs">
                Assim que um criador publicar um vídeo na categoria "Interativo", aparece aqui automaticamente.
              </p>
            </div>
