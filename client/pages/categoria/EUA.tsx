...
export default function EUAPage() {
  useDocumentTitle({ title: "Vídeos dos EUA - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("eua-videos-rt")
    ...
    const ch2 = supabase.channel("eua-likes-rt")
