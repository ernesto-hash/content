// src/pages/categoria/CurtoAuthenticated.tsx
...
export default function CurtoAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("curto-auth-videos-rt")
    ...
    const ch2 = supabase.channel("curto-auth-likes-rt")
