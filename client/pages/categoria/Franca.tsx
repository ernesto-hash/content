// src/pages/categoria/França.tsx
...
export default function FrancaPage() {
  useDocumentTitle({ title: "Vídeos de França - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("frança-videos-rt")
    ...
    const ch2 = supabase.channel("frança-likes-rt")
