...
export default function SoloPage() {
  useDocumentTitle({ title: "Vídeos Solo - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("solo-videos-rt")
    ...
    const ch2 = supabase.channel("solo-likes-rt")
