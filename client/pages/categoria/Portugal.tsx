// src/pages/categoria/Portugal.tsx
...
export default function PortugalPage() {
  useDocumentTitle({ title: "Vídeos de Portugal - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("portugal-videos-rt")
    ...
    const ch2 = supabase.channel("portugal-likes-rt")
