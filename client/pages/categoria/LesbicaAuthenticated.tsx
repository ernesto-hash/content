// src/pages/categoria/LésbicaAuthenticated.tsx
...
export default function LesbicaAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("lésbica-auth-videos-rt")
    ...
    const ch2 = supabase.channel("lésbica-auth-likes-rt")
