...
export default function GrupoPage() {
  useDocumentTitle({ title: "Vídeos Grupo - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("grupo-videos-rt")
    ...
    const ch2 = supabase.channel("grupo-likes-rt")
