// src/pages/categoria/Alemanha.tsx
...
export default function AlemanhaPage() {
  useDocumentTitle({ title: "Vídeos da Alemanha - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("alemanha-videos-rt")
    ...
    const ch2 = supabase.channel("alemanha-likes-rt")
