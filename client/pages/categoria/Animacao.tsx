// src/pages/categoria/Animação.tsx
...
export default function AnimacaoPage() {
  useDocumentTitle({ title: "Vídeos Animação - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("animação-videos-rt")
    ...
    const ch2 = supabase.channel("animação-likes-rt")
