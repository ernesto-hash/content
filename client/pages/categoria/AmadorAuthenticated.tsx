// src/pages/categoria/AmadorAuthenticated.tsx
...
export default function AmadorAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("amador-auth-videos-rt")
    ...
    const ch2 = supabase.channel("amador-auth-likes-rt")
