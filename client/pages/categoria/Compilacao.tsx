// src/pages/categoria/Compilação.tsx
...
export default function CompilacaoPage() {
  useDocumentTitle({ title: "Compilações XXX - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("compilação-videos-rt")
    ...
    const ch2 = supabase.channel("compilação-likes-rt")
