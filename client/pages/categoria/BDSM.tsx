...
export default function BDSMPage() {
  useDocumentTitle({ title: "Vídeos BDSM - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("bdsm-videos-rt")
    ...
    const ch2 = supabase.channel("bdsm-likes-rt")
