...
export default function TransPage() {
  useDocumentTitle({ title: "Vídeos Trans - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("trans-videos-rt")
    ...
    const ch2 = supabase.channel("trans-likes-rt")
