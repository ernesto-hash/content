// src/pages/categoria/JapãoAuthenticated.tsx
...
export default function JapaoAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("japão-auth-videos-rt")
    ...
    const ch2 = supabase.channel("japão-auth-likes-rt")
