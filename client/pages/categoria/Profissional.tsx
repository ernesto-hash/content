// src/pages/categoria/Profissional.tsx
...
export default function ProfissionalPage() {
  useDocumentTitle({ title: "Vídeos Profissionais - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("profissional-videos-rt")
    ...
    const ch2 = supabase.channel("profissional-likes-rt")
