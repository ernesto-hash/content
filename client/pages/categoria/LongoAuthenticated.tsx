// src/pages/categoria/LongoAuthenticated.tsx
...
export default function LongoAuthenticatedPage() {
  ...
  useEffect(() => {
    const ch1 = supabase.channel("longo-auth-videos-rt")
    ...
    const ch2 = supabase.channel("longo-auth-likes-rt")
