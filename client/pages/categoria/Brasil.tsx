// src/pages/categoria/Brasil.tsx
...
export default function BrasilPage() {
  useDocumentTitle({ title: "Vídeos do Brasil - SuckOrSex" });
  ...
  useEffect(() => {
    const ch1 = supabase.channel("brasil-videos-rt")
    ...
    const ch2 = supabase.channel("brasil-likes-rt")
