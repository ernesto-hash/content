...
export default function FotosGifAuthenticated() {
  ...
  const fotos = {
    populares: [
      {
        id: 1,
        title: "Ensaio Fotográfico - Luna Star",
        description: "Fotos exclusivas do ensaio mais recente do mês",
        image:
      ...
      },
      {
        ...
        description: "Registros espontâneos nos bastidores",
        image:
      ...
      },
      {
        id: 3,
        title: "Dia de Praia",
        description: "Ensaio ao ar livre em praia paradisíaca",
        image:
          "https://images.unsplash.com/photo-1516726817505-f5ed825624d8?w=800&h=1200&fit=crop",
        thumbnail:
      ...
      {
        id: 4,
        title: "Editorial Vermelho",
        description: "Ensaio temático com look vermelho",
        image:
          "https://images.unsplash.com/photo-1502323777036-f29e3972d82f?w=800&h=1200&fit=crop",
        thumbnail:
        ...
        authorAvatar:
          "https://images.unsplash.com/photo-1494790108777-383d5602d5c2?w=100&h=100&fit=crop",
        verified: false,
        vip: false,
        category: "Editorial",
        tags: ["editorial", "vermelho"],
        date: "1 dia atrás",
        resolution: "HD",
        size: "1.9 MB",
      },
      {
        id: 5,
        title: "Ensaio em Dupla",
        description: "Sessão fotográfica em dupla com clima romântico",
        image:
          "https://images.unsplash.com/photo-1548142813-c34835dfe326?w=800&h=1200&fit=crop",
        thumbnail:
          "https://images.unsplash.com/photo-1548142813-c34835dfe326?w=400&h=600&fit=crop",
        type: "photo",
        width: 800,
        height: 1200,
        views: "1.5M",
      ...
      },
      {
        ...
        description: "Sessão focada em detalhes e composição",
        image:
    ...
    gifs: [
      {
        id: 7,
        title: "Dança - Loop",
        description: "GIF animado com coreografia",
      ...
      {
        id: 8,
        title: "Momento em Dupla",
        description: "GIF de dupla em cena",
      ...
      },
      {
        ...
        description: "GIF curto de performance",
        gif: "https://media.giphy.com/media/3o7abB06u9bNzA8LC8/giphy.gif",
        thumbnail:
          "https://media.giphy.com/media/3o7abB06u9bNzA8LC8/giphy.gif",
        type: "gif",
      ...
      {
        id: 10,
        title: "Expressão - Close",
        description: "GIF com close e expressão marcante",
        gif: "https://media.giphy.com/media/l0MYt5jH6gkTWm8qo/giphy.gif",
        thumbnail:
          "https://media.giphy.com/media/l0MYt5jH6gkTWm8qo/giphy.gif",
        type: "gif",
  ...
  const categories = [
    ...
    { id: "editorial", label: "Editorial", icon: Gift },
    { id: "dupla", label: "Dupla", icon: Users },
    { id: "solo", label: "Solo", icon: User },
    { id: "criativo", label: "Criativo", icon: Zap },
  ...
  const PhotoCard = ({ photo }: { photo: any }) => (
    ...
    >
      ...
      <div className="absolute bottom-2 left-2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        {photo.verified && <CheckCircle size={10} className="text-neon-blue" />}
      </div>
    </div>
  );
      ...
      <div className="flex-1 py-2 pr-3">
        ...
        <div className="flex flex-wrap gap-1 mt-2">
          {photo.tags.slice(0, 3).map((tag: string, index: number) => (
            <span
              key={index}
              className="text-[10px] px-2 py-0.5 bg-white/5 rounded-full text-foreground/40"
            >
              #{tag}
            </span>
          ))}
      ...
      <div className="flex-1 py-2 pr-3">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex items-center gap-1">
            ...
            {gif.verified && <CheckCircle size={10} className="text-neon-blue" />}
          </div>
      ...
      <div className="flex-1 py-2 pr-3">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex items-center gap-1">
            ...
            {album.verified && <CheckCircle size={10} className="text-neon-blue" />}
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {selectedMedia.comments && (
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <MessageCircle
                          size={16}
                          className="mx-auto mb-1 text-neon-purple"
                        />
                        <p className="text-lg font-bold text-foreground">
                          {selectedMedia.comments}
                        </p>
                    ...
                    {selectedMedia.shares && (
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <Share2
                          size={16}
                          className="mx-auto mb-1 text-neon-blue"
                        />
                        <p className="text-lg font-bold text-foreground">
                          {selectedMedia.shares}
                        </p>
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {selectedMedia.tags.map((tag: string, index: number) => (
                      <span
                        key={index}
                        className="text-xs px-2 py-1 bg-white/5 rounded-full text-foreground/60"
                      >
                        #{tag}
                      </span>
                    ))}
      ...
      <div className="max-container safe-area py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-foreground/60">
              Explore milhares de fotos e GIFs em alta qualidade
            </p>
          </div>
        ...
        <section className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground/80">Editorial</span>
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground/80">Dupla</span>
