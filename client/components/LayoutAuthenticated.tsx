...
import { 
  ...
  BarChart3, Settings, Bookmark as BookmarkIcon
} from "lucide-react";
...
export default function LayoutAuthenticated({ children, hideHeader = false }: LayoutAuthenticatedProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-56 glass-dark border border-white/10 rounded-xl shadow-lg overflow-hidden z-50">
                    <div className="p-3 border-b border-white/10">
                      ...
                      <p className="text-xs text-foreground/40">Membro verificados</p>
                    </div>
                    ...
                    <div className="p-2">
                      ...
                      >
                        <User size={16} />
                        <span className="text-sm">Seu canal</span>
                      </Link>
      ...
      {/* Main Content - CORRIGIDO: Agora sem padding duplicado, apenas o que vem do children */}
        ...
        <div className="max-container safe-area py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-foreground/60 text-sm">
                <li><a href="#" className="hover:text-neon-blue transition-colors">Termos de Serviço</a></li>
                <li><a href="#" className="hover:text-neon-pink transition-colors">Privacidade</a></li>
